USE [PROMOCION_DB]
GO
/****** Object:  Table [dbo].[Premios]    Script Date: 05/28/2019 18:57:16 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  Table [dbo].[Participantes]    Script Date: 05/28/2019 18:57:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Vouchers]    Script Date: 05/28/2019 18:57:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Vouchers] ([CodigoVoucher], [Participante], [CodigoProducto], [Estado]) VALUES (N'AS489SD1  ', N'34521771', N'3         ', 1)
INSERT [dbo].[Vouchers] ([CodigoVoucher], [Participante], [CodigoProducto], [Estado]) VALUES (N'PA548FG3  ', NULL, NULL, 0)
INSERT [dbo].[Vouchers] ([CodigoVoucher], [Participante], [CodigoProducto], [Estado]) VALUES (N'PE548DS2  ', NULL, NULL, 0)
INSERT [dbo].[Vouchers] ([CodigoVoucher], [Participante], [CodigoProducto], [Estado]) VALUES (N'XA123LN1  ', NULL, NULL, 0)
/****** Object:  Default [DF_Vouchers_Estado]    Script Date: 05/28/2019 18:57:16 ******/
ALTER TABLE [dbo].[Vouchers] ADD  CONSTRAINT [DF_Vouchers_Estado]  DEFAULT ((0)) FOR [Estado]
GO
/****** Object:  ForeignKey [FK_Voucher_Productos]    Script Date: 05/28/2019 18:57:16 ******/
...
GO
/****** Object:  ForeignKey [FK_Voucher_Usuarios]    Script Date: 05/28/2019 18:57:16 ******/
