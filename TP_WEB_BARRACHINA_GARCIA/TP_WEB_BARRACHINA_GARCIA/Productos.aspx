...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class ="ContenedorPrincipal">
        <div class ="ContenedorProductos"> 
            ...
            <p> <asp:Button ID="BtnAceptar" runat="server" Text="Elegir" OnClick="btnAceptar_Click"/></p>
        </div>
          <div class ="ContenedorProductos"> 
            ...
            <p> <asp:Button ID="Button1" runat="server" Text="Elegir" OnClick="btnAceptar_Click"/></p>
        </div>
          <div class ="ContenedorProductos"> 
            ...
            <p> <asp:Button ID="Button2" runat="server" Text="Elegir" OnClick="btnAceptar_Click"/></p>
        </div>
              <div class ="ContenedorProductos"> 
            ...
            <p> <asp:Button ID="Button3" runat="server" Text="Elegir" OnClick="btnAceptar_Click"/></p>
        </div>
    </div>
