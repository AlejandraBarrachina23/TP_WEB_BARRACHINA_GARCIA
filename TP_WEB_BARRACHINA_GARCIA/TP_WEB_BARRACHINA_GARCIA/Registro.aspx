...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class ="form-register">
        ...
        <div class="form-groups"> 
		    ...
		    <asp:TextBox ID="tboxDNI" class="input" runat="server" OnTextChanged="tboxDNI_TextChanged" AutoPostBack="true"></asp:TextBox>
        </div>
        <div class="form-groups">       
		    <asp:Label ID="lblApellido" runat="server" Text="Apellido"></asp:Label><br />
	        <asp:TextBox ID="tboxApellido" class="input" runat="server"></asp:TextBox>
		</div>
        <div class="form-groups"> 
            <asp:Label ID="lblNombre" runat="server" Text="Nombre"></asp:Label><br />
		    <asp:TextBox ID="tboxNombre" class="input" runat="server"></asp:TextBox>
        </div>
		<div class="form-groups"> 
            <asp:Label ID="lblMail" runat="server" Text="E-mail"></asp:Label><br />
		    <asp:TextBox ID="tboxMail" class="input" runat="server"></asp:TextBox>
        </div>
        <div class="form-groups"> 
		    <asp:Label ID="lblDireccion" runat="server" Text="Dirección"></asp:Label><br />
		    <asp:TextBox ID="tboxDireccion" class="input" runat="server"></asp:TextBox>
        </div>
        <div class="form-groups"> 
		    <asp:Label ID="lblCiudad" runat="server" Text="Ciudad"></asp:Label><br />
		    <asp:TextBox ID="tboxCiudad" class="input" runat="server"></asp:TextBox>
        </div>
        <div class="form-groups"> 
		    <asp:Label ID="lblCP" runat="server" Text="Código Postal"></asp:Label><br />
		    <asp:TextBox ID="tboxCP" class="input" runat="server"></asp:TextBox>
		</div>
		    <asp:Button ID="btnAceptar" class="boton" runat="server" Text="Participar" OnClick="btnAceptar_Click" />
    </div>
